 ...
 * handled by a callback to mbbma_comment() which is
	...
	<?php if ( have_comments() ) : ?>
		...
		<ol class="comment-list">
			<?php
				 ...
				 * to use mbbma_comment() to format the comments.
				 * If you want to override this in a child theme, then you can
				 * define mbbma_comment() and that will be used instead.
				 * See mbbma_comment() in inc/template-tags.php for more.
				 */
